                    ...
                    <form onSubmit={evt => register(evt, email, firstName, lastName, password)}>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                <input onChange={this.handleInputChange} type="text" id="email" className="form-control"
                        ...
                        <div className="form-group row">
                            <label htmlFor="firstName" className="col-md-3 col-form-label text-md-right">First
                                Name</label>
                            <div className="col-md-8">
                                <input onChange={this.handleInputChange} type="text" id="firstName"
                        ...
                        <div className="form-group row">
                            <label htmlFor="lastName" className="col-md-3 col-form-label text-md-right">Last
                                Name</label>
                            <div className="col-md-8">
                                <input onChange={this.handleInputChange} type="text" id="lastName"
                                       className="form-control"
                                       name="email" required autoFocus/>
                            </div>
                        </div>
                        ...
                        <div className="col-md-10 offset-md-2">
                            <Link to="/vendor" className="btn btn-link"> Create Vendor Account </Link>
